...
import { HeartIcon as Heart, XIcon as X, BookmarkSimpleIcon as Bookmark } from 'phosphor-react-native';
...
export const SwipeCardNew: React.FC<SwipeCardProps> = ({ event, onSwipe, onSwipeUp }) => {
