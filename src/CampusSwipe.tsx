...
export default function CampusSwipe() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:to-slate-800">
      {/* Top Bar */}
      <div className="sticky top-0 z-30 border-b bg-white/80 dark:bg-slate-900/80 backdrop-blur">
        ...
        <div className="lg:col-span-5">
          <div className="relative h-[560px]">
            ...
            {top ? (
              ...
              <div className="flex h-full items-center justify-center rounded-2xl border bg-white dark:bg-slate-800">
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="text-xs font-medium text-slate-600 dark:text-slate-400">Clubs</div>
              ...
              <div className="max-h-[320px] space-y-2 overflow-auto pr-1">
                {filtered.map((e) => (
                  <div
                    key={e.id}
                    className="flex items-center gap-3 rounded-xl border p-2 hover:bg-slate-50 dark:hover:bg-slate-800"
                  >
            ...
            <CardContent className="space-y-3">
              {MOCK_FRIENDS.map((f) => (
                <div key={f.id} className="rounded-xl border p-3">
                  <div className="flex items-center gap-2">
                    <div className="h-7 w-7 rounded-full bg-slate-100 dark:bg-slate-700 grid place-items-center text-base">
                      {f.avatar}
                    </div>
      ...
      <div className="mx-auto max-w-7xl p-4">
        <div className="rounded-2xl border bg-white dark:bg-slate-800 p-3 shadow-sm">
